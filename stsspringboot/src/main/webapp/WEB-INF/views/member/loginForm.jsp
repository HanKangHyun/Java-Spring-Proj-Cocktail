...
<div class="container">
	<form action="/auth/loginProc" method="post">
		...
		<a href="https://kauth.kakao.com/oauth/authorize?client_id=d1080fd0a8d6558ec6e1c02563c8b208&redirect_uri=http://localhost:8080/auth/kakao/callback&response_type=code">
